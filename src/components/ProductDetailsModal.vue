<template>
  ...
  >
    <div class="bg-gradient-to-br from-blue-900 to-black rounded-2xl shadow-2xl w-full max-w-3xl overflow-hidden relative border border-purple-400/30">
      ...
      <!-- Botón cerrar -->
      <button
        class="absolute top-4 right-4 z-10 bg-black/40 hover:bg-black/60 text-white/80 hover:text-white p-2 rounded-full transition-all duration-300 border border-white/20 backdrop-blur-sm"
        @click="emit('close')"
      >
